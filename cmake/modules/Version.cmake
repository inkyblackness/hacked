...
if ("${GIT_REVISION}" STREQUAL "")
    ...
    set(REPO_SHORT_VERSION "unknown" CACHE STRING "" FORCE)
else ()
    execute_process(COMMAND ${GIT_EXECUTABLE} describe --exact-match --tags OUTPUT_VARIABLE GIT_TAG ERROR_QUIET)
    string(STRIP "${GIT_REVISION}" GIT_REVISION)
    string(STRIP "${GIT_TAG}" GIT_TAG)
    if ("${GIT_TAG}" STREQUAL "")
        set(REPO_SHORT_VERSION "rev${GIT_REVISION}" CACHE STRING "" FORCE)
    else ()
        set(REPO_SHORT_VERSION "${GIT_TAG}" CACHE STRING "" FORCE)
    endif ()
endif ()

set(REPO_LONG_VERSION "${REPO_SHORT_VERSION}@${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}" CACHE STRING "" FORCE)
